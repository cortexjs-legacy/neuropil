...
Cacher.prototype.save_document = function(name, document) {
  var documents = this._cache.documents;
...
Cacher.prototype.get_document = function(name) {
  return this._cache.documents[name];
};


Cacher.prototype.save_package = function(name, version) {
  this._push('packages', name, version);
};
...
Cacher.prototype.exists = function(name, version) {
  return ~this._indexOf('packages', name, version);
};
