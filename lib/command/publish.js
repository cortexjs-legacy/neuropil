...
exports.run = function (options, callback) {
    ...
    this.read_tarball(options, function (err) {
        ...
        // 1. try publish the package
        // 2. if conflict, get package info, and check if we should override the version
        // 3. if should not, fail
        // 4. or unpublish and republish
